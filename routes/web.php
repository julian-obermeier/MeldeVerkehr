...
if ($installerService->isInstalled()) {
    ...
    $app->router()->post('/community/u/{username}/follow', [$community, 'followUser']);
    $app->router()->post('/community/u/{username}/unfollow', [$community, 'unfollowUser']);
    $app->router()->get('/community/network', [$community, 'network']);
    $app->router()->get('/community/favorites', [$community, 'favorites']);
    ...
    $app->router()->get('/community/groups/{id}/chat', [$community, 'groupChat']);
    $app->router()->post('/community/groups/{id}/chat', [$community, 'sendGroupMessage']);
    ...
    $app->router()->post('/community/posts/{id}/favorite', [$community, 'favoritePost']);
    $app->router()->post('/community/posts/{id}/unfavorite', [$community, 'unfavoritePost']);
