...
<style>body{font-family:system-ui,sans-serif;background:#f5f7fa;color:#172033;margin:0}main{max-width:1000px;margin:35px auto;padding:20px}.card{background:#fff;border:1px solid #dfe5ec;border-radius:16px;padding:24px}.actions{display:flex;gap:12px;flex-wrap:wrap}.button,button{padding:11px 16px;border-radius:9px;border:0;background:#172033;color:#fff;text-decoration:none;font-weight:700}.muted{color:#66758a}</style></head>
...
<?php if($isSuperAdmin):?><p class="muted">Rolle: Superadministrator</p><?php endif;?>
<div class="actions"><span class="button" aria-disabled="true">Neue Meldung – folgt in M2</span></div>
